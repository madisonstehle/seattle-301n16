...
function displayPics(){
  ...
  // 'rando' is declared inside of a function, making it a local variable for that function. So, the scope for the variable won't reach outside of that function.
  console.log(viewed);
